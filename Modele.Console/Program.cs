...
namespace Modele.ProductManager.Console
{
    ...
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            int productDDID = bm.AjouterProduit(new Produit() { Code = "X001", Nom = "Disque Dur", Status = "En Stock", Stock = 10, Prix = 255.5F, CategorieID = 1, CommandeID = commandeJulien });
            bm.AjouterProduit(new Produit() { Code = "X002", Nom = "Carte graphique", Status = "En Stock", Stock = 5, Prix = 560.5F, CategorieID = 1, CommandeID = commandePierre });
            bm.AjouterProduit(new Produit() { Code = "X003", Nom = "Alimentation", Status = "Destockage", Stock = 2, Prix = 120.5F, CategorieID = 1, CommandeID = commandePierre });
            ...
            bm.AjouterLogProduit(new LogProduit() { Date="15/06/2016", LogInfo="Ajout d'un disque !", ProduitId = productDDID });
            bm.AjouterLogProduit(new LogProduit() { Date = "18/06/2016", LogInfo = "Entré d'un Western Digital CB !", ProduitId = productDDID });
